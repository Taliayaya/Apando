...
const ResetPassword = () => {
    ...
    return (
        <StyledLoginPage>
            <StyledHeaderTitle>Réinitialiser le mot de passe</StyledHeaderTitle>
            <StyledLoginWrapper>
                <StyledLoginTitle>Mot de passe oublié</StyledLoginTitle>
                <StyledText>
                    Vous avez oublié votre mot de passe ? Pas de soucis, vous
                    pouvez d'ici envoyer un mail de réinitialisation de mot de
                    passe à partir de l'adresse mail de votre compte.
                </StyledText>
                {error && <StyleError>{error}</StyleError>}
                {sentMessage && <StyleAlert success>{sentMessage}</StyleAlert>}
                <StyledForm action="#">
                    <StyledField>
                        <StyledFieldInput
                            type="email"
